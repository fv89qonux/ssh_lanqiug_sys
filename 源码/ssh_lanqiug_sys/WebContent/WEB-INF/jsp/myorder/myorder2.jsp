	...
	<body>
		<div class="admin-main">
			...
			<fieldset class="layui-elem-field">
				<legend>订单列表</legend>
				<a href="${ctx}/myorder_add.do?userId="+${userId} class="layui-btn layui-btn-small" id="add">
					<i class="layui-icon">&#xe608;</i> 预定球场
				</a>
        ...
        <tr>
           ...
           <td>${data.consume}</td>
           <td>
              <div class="button-group"><a class="layui-btn layui-btn-danger layui-btn-mini" href="${ctx}/myorder_delete.do?id=${data.id}">删除</a></div>
           </td>
        </tr>
       </c:forEach>
       <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="${ctx}/myorder_myorder2.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
