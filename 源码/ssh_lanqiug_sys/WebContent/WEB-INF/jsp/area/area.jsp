...
<html>
	...
	<body>
		<div class="admin-main">
			...
			<form class="layui-form" method="post" action="${ctx}/area_area.do" id="listform">
				<table>
					<tr>
						<td style="width:20%;">					
						...
						<td style="width:20%;">
							...
							<div class="layui-input-block" style="width: 190px;">
								<select name="state" lay-filter="zhungtai" id="zhuangtai">
									<option></option>
			...
			<fieldset class="layui-elem-field">
				<legend>球场列表</legend>
				<a href="${ctx}/area_add.do" class="layui-btn layui-btn-small" id="add">
					<i class="layui-icon">&#xe608;</i> 添加球场
				</a>
        ...
        <tr>
           ...
           <td>
              <div class="button-group"> <a class="layui-btn layui-btn-mini" href="${ctx}/area_update.do?id=${data.id}">修改</a> <a class="layui-btn layui-btn-danger layui-btn-mini" href="${ctx}/area_delete.do?id=${data.id}">删除</a></div>
           </td>
        </tr>
       </c:forEach>
       <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="${ctx}/App_app.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
