...
<html>
	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="${ctx}/area_exUpdate.do" enctype="multipart/form-data" onsubmit="return toVaild()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 190px;">
						<select name="type" lay-filter="leixing" id="leixing">
