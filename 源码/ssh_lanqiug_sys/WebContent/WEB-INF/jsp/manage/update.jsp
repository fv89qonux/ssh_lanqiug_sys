...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${ctx}/manage_exUpdate.do" enctype="multipart/form-data"> 
    <input type="hidden" name="id" value="${Manage.id}">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="name" value="${Manage.name }" data-validate="required:请输入名称" />         
          <div class="tips"></div>
        </div>
      </div> 
        <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="realName" value="${Manage.realName }" data-validate="required:请输入真实名" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="passWord" value="${Manage.passWord }" data-validate="required:请输入密码" />         
          <div class="tips"></div>
        </div>
      </div> 
     <div class="form-group">
