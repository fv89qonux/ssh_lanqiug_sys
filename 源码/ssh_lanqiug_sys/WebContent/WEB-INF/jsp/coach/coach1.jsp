...
<html>
	...
	<body>
		<div class="admin-main">
			...
			<form class="layui-form" method="post" action="${ctx}/coach_coach1.do" id="listform">
				<table>
					<tr>
						<td style="width:18%;">					
							<label class="layui-form-label">年龄:</label>
							<div class="layui-input-inline">
								<input type="text" class="layui-input" name="age" value="${Obj.age}" style="width:160px;">
							</div>
						</td>
						<td style="width:18%;">					
							<label class="layui-form-label">价格:</label>
							<div class="layui-input-inline">
								<input type="text" class="layui-input" name="price" value="${Obj.price}" style="width:160px;">
							</div>
						</td>
						<td style="width:18%;">
						...
						<td style="width:18%;">
							<a href="javascript:;" class="layui-btn layui-btn-small" id="search" onclick="changesearch()" style="    margin-left: 120px;">
        ...
        <tr>
           ...
           <td>
              <div class="button-group"> <a class="layui-btn layui-btn-mini" href="${ctx}/coach_update1.do?id=${data.id}">
              	<c:if test="${data.state == 0}">
           		休息
            	</c:if>
            	<c:if test="${data.state == 1}">
       ...
       <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="${ctx}/coach_coach1.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
