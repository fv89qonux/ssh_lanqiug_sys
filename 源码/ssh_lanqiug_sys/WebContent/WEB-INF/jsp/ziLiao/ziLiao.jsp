  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
       <li>
           <a class="button border-main icon-plus-square-o" href="${ctx }/ziLiao_add.do"> 添加</a> 
        </li>
      </ul>
    </div>
    <table class="table table-hover text-center">
      ...
      <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="${ctx}/ziLiao_ziLiao.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location.href="${ctx}/ziLiao_delete.do?id="+id;
	}
}
