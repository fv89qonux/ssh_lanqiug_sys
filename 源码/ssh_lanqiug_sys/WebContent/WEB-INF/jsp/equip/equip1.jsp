...
<html>
	...
	<body>
		<div class="admin-main">
			...
			<form class="layui-form" method="post" action="${ctx}/equip_equip1.do" id="listform">
				<table>
					<tr>
						<td style="width:20%;">					
        ...
        <tr>
           ...
           <td>
              <div class="button-group"> <a class="layui-btn layui-btn-mini" href="${ctx}/equip_update1.do?id=${data.id}">
              	<c:if test="${data.state == 0}">
           		休息
            	</c:if>
            	<c:if test="${data.state == 1}">
       ...
       <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="${ctx}/equip_equip1.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
