...
<div class="indexCont">
	...
	<div class="menu_nav clearfix">
        ...
        <div class="search">
        	<form action="${ctx }/news_news2.do">
           <input class="s_txt" type="text" name="title" value="${Obj.title }"/>
           <input class="s_txt" type="hidden" name="type" value="${Obj.type }"/>
...
<div class="gzdt">
	...
	<div class="gzdt_list">
	 ...
	 <div class="list_a">
			...
			<div class="list_tit">
				<a target="_blank" class="list01" href="${ctx}/news_view.do?id=${data.id}" title="">${data.title}
				</a>
			</div>
			<div class="list_time">
				${data.addTime}
	...
	<div id="paging" style="width: 480px;">
					 <!-- 分页开始 -->
			      <pg:pager  url="${ctx}/news_news2.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
			        
			        <pg:param name="type" value="${Obj.type}"/>
