...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${ctx}/news_exUpdate.do" enctype="multipart/form-data"> 
    <input type="hidden" name="id" value="${Obj.id}">  
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="title" value="${Obj.title}" data-validate="required:请输入名称" />         
          <div class="tips"></div>
        </div>
      </div> 
      <div class="form-group">
