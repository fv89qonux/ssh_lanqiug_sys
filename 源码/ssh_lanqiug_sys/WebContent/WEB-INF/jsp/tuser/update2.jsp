...
<html>
	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="${ctx}/tuser_exUpdate2.do" enctype="multipart/form-data" onsubmit="return toVaild()">
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" name="ye" autocomplete="off" class="layui-input" value="${Obj.ye}" readonly="readonly">
						</div>
					</div>
				</div>
				<div class="layui-form-item">
