...
<html>
	...
	<body>
		<div style="margin: 15px;">
			...
			<form class="layui-form" action="${ctx}/tuser_exAdd.do" enctype="multipart/form-data" onsubmit="return toVaild()">
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-block">
							<input type="text" name="brithday" id="date"  placeholder="yyyy-mm-dd" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">
						</div>
					</div>
				</div>
				<div class="layui-form-item">
