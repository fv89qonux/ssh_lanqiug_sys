...
<html>
	...
	<body>
		<div class="admin-main">
			...
			<form class="layui-form" method="post" action="${ctx}/tuser_user.do" id="listform">
				<table>
					<tr>
						<td style="width:20%;">					
			...
			<fieldset class="layui-elem-field">
				<legend>教练列表</legend>
				<a href="${ctx}/tuser_add.do" class="layui-btn layui-btn-small" id="add">
        ...
        <tr>
           ...
           <td>
              <div class="button-group"> <a class="layui-btn layui-btn-mini" href="${ctx}/tuser_update.do?id=${data.id}">修改</a> <a class="layui-btn layui-btn-danger layui-btn-mini" href="${ctx}/tuser_delete.do?id=${data.id}">删除</a></div>
           </td>
        </tr>
       </c:forEach>
       <tr>
