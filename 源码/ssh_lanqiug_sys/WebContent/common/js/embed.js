//原文件：http://static.duoshuo.com/embed.js
//显UA开始
...
function ua(e) {
	...
	if (r = e.match(/MSIE\s([^\s|;]+)/gi)) {
		...
		var r1 = r[0].split("/");
		outputer = '<span class="ua_firefox"><i class="fa fa-globe"></i>FireFox ' + r1[1]
		...
		outputer = '<span class="ua_2345explorer"><a href="http://www.91txh.com/2345download.php?id=2" target="_blank" style="color:#FFFFFF!important;"><i class="fa fa-globe"></i>2345王牌浏览器</a>'
	} else if (r = e.match(/2345chrome/ig)) {
		outputer = '<span class="ua_2345chrome"><a href="http://www.91txh.com/2345download.php?id=3" target="_blank" style="color:#FFFFFF!important;"><i class="fa fa-globe"></i>2345加速浏览器</a>'
...
function os(e) {
	...
	if (e.match(/win/ig)) {
		if (e.match(/nt 5.1/ig)) {
			...
			os = '<span class="os_windows"><i class="fa fa-desktop"></i>Windows 10'
		}
...
(function(e, t, n) {
			...
			ajax: function(e, t, r, o, u) {
				...
				if (s && i && i.parse) {
					...
					if ( !! f && "withCredentials" in f) {
						...
						function c(e, t, n, r) {
							var s, a, f, l = t;
							if (e >= 200 && e < 300 || e === 304) if (e === 304) l = "notmodified", s = !0;
							else try {
	...
	var J = w.templates = {
		...
		avatar: function(e, t) {
			var n = J.avatarImg(e, t),
				r = J.userUrl(e);
			return r ? '<a rel="nofollow author" target="_blank" href="' + p(r) + '" ' + (e.user_id ? " onclick=\"this.href='http://ssk.91txh.com/redirect.php?type=unknow&url=" + w.hostUrl + "/user-url/?user_id=" + e.user_id + "';\"" : "") + ' title="' + p(e.name) + '">' + n + "</a>" : n
		},
	...
	tt.on("queryDefined", function() {
		...
		w.resetNotify = function() {
			...
			return '<li class="ds-post" data-post-id="' + e.post_id + '"><div class="ds-post-self" data-post-id="' + e.post_id + '" data-thread-id="' + e.thread_id + '" data-root-id="' + e.root_id + '" data-source="' + e.source + '"><div class="ds-avatar"' + r + ">" + J.avatar(n) + (w.sourceName[e.source] ? J.serviceIcon(e.source) : "") + '</div><div class="ds-comment-body"><div class="ds-comment-header">' + (n.url ? '<a class="ds-user-name ds-highlight" data-qqt-account="' + s + '" href="' + p(n.url) + '" ' + (n.user_id ? " onclick=\"this.href='http://ssk.91txh.com/redirect.php?type=unknow&url=" + w.hostUrl + "/user-url/?user_id=" + n.user_id + "';\"" : "") + ' rel="nofollow" target="_blank"' + r + ">" + p(n.name) + "</a>" : '<span class="ds-user-name"' + r + ' data-qqt-account="' + s + '">' + p(n.name) + "</span>") + "<span class=\"ua\">" + ua(e.agent) + "</span><span class=\"ua\">" + os(e.agent) + "</span>" + "</div>" + (t.max_depth == 1 && t.show_context && u.length ? '<ol id="ds-ctx">' + i.map(u, function(e, t) {
		...
		bubbleOut = function() {
			...
			return i.each(e.social_uid, function(e, n) {
				t.push('<a href="http://ssk.91txh.com/redirect.php?type=unknow&url=' + w.REMOTE + "/user-proxy/" + e + "/" + n + '/" target="_blank" class="ds-service-icon ds-' + e + '" title="' + w.sourceName[e] + '"></a>')
			}), '<a href="http://ssk.91txh.com/redirect.php?type=unknow&url=' + p(e.url) + '" class="ds-avatar" target="_blank">' + J.avatarImg(e) + '</a><a href="http://ssk.91txh.com/redirect.php?type=unknow&url=' + p(e.url) + '" class="ds-user-name ds-highlight" target="_blank">' + p(e.name) + "</a>" + t.join("") + '<p class="ds-user-card-meta"><a href="http://ssk.91txh.com/redirect.php?type=unknow&url=' + w.REMOTE + "/profile/" + e.user_id + '/" target="_blank"><span class="ds-highlight">' + e.comments + "</span>\u6761\u8bc4\u8bba</a></p>" + (e.description ? '<p class="ds-user-description">' + p(e.description) + "</p>" : "")
			...
			var t = J.logoutUrl();
			return '<div class="ds-toolbar"><div class="ds-account-control"><span class="ds-icon ds-icon-settings"></span> <span>\u5e10\u53f7\u7ba1\u7406</span><ul><li><a class="ds-bind-more" href="javascript:void(0);" style="border-top: none">\u7ed1\u5b9a\u66f4\u591a</a></li><li><a target="_blank" href="http://ssk.91txh.com/redirect.php?type=unknow&url=' + w.REMOTE + "/settings/" + W(X()) + '">' + p(k.settings) + "</a></li>" + '<li><a rel="nofollow" href="' + t + '" style="border-bottom: none">\u767b\u51fa</a></li>' + "</ul>" + "</div>" + '<div class="ds-visitor">' + (rt.data.url ? '<a class="ds-visitor-name" href="' + p(rt.data.url) + '" target="_blank">' + p(rt.data.name) + "</a>" : '<span class="ds-visitor-name">' + p(rt.data.name) + "</span>") + '<a class="ds-unread-comments-count" href="javascript:void(0);" title="\u65b0\u56de\u590d"></a>' + "</div>" + "</div>"
